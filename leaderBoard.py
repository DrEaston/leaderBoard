...
class scoreSheet:
    ...
    """ print stuff """           
    def printLeaders(self,category,numScores,week): #print leaderboard. "namesScores" is generated by "getLeaders" 
            if len(getattr(self,category)[week])>0:
                if numScores=='all':  #numScores indicates how many scores to print. 'all' prints all leaders (those with scores)
                    numScores=len(getattr(self,category)[week])
                for x in range(1,numScores+1):
                    str1=getattr(self,category)[week][1][-x]
                    str_length=len(str1)+(13-len(getattr(self,category)[week][1][-x]))
                    str1=str1.ljust(str_length)
                    print(str1 + "  -  " + str(int(getattr(self,category)[week][0][-x])))
                print("\n")
...
print("The total points leaders are:")
intSci.printLeaders('score',10,1)

print("The leaders for most Hundos (100% quizzes) are:")
intSci.printLeaders('hundos',10,1)

print("The Chemistry points leaders are:")
intSci.printLeaders('chemistry',10,1)

print("The Astronomy points leaders are:")
intSci.printLeaders('astronomy',10,1)

print("Quiz warriors (Those with most quiz attempts) :")
intSci.printLeaders('noQuizzes',10,1)

print("The leading earth scientists are:")
intSci.printLeaders('earthSci',10,1)
